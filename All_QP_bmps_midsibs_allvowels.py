...
#                print(sm)
                    ...
                    meanfrm = int(sm.tier('raw_data_idx').label_at(st_frmtime).text)
                framenos.append(meanfrm)
                framename = timestamp + '.' + str(meanfrm) + '.jpg'
...
outdiffs = os.path.join(subbmpdir,'midframe_s_diffs.txt')
